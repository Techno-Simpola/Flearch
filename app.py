...
def fun():
    client = pymongo.MongoClient("mongodb+srv://Search-DB:password-glugledb@cluster0.igzqx.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", connect=False)
    db = client.glugledb
